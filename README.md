...
- Inline
  ...
  -  인라인 블럭으로 처리하고 싶은 부분은 ` (백틱)으로 감싸줍니다.
- Block 
...
<img src="C:\Users\rn061\OneDrive\바탕 화면\git이미지.png" style="zoom:33%;" /><img src="C:\Users\rn061\OneDrive\바탕 화면\GitHub-logo.png" style="zoom:20%;" />     
...
- `[]()` 을 작성하고 `()` 안에 링크 주소를 작성하고 `[]` 안에 어떤 링크 주소이지 작성합니다.
...
- 인문용 안에 인문용을 작성하면 중첩해서 사용할 수 있습니다.

  >$ git add.
  >
  >> $ git commit -m "first commit"
  >>
  >> > $ git puxh origin master
